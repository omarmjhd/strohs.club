...
logo: /brand/comp-two-step.png
tagline: STROH's Major — a two-day net ringer for the NIT spot and a Roost Regional seat.
blurb: Our Major — a two-day net ringer. Winner takes the NIT spot.
summary: >-
  The Texas Two-Step is STROH's Major: a two-day net stroke-play "ringer" on a Friday–Saturday in
  January 2027 (exact dates TBD). Play the same course both days, and for each hole your best net
  score of the two days counts toward a single 18-hole ringer card. The champion is STROH's NIT
  qualifier and a Roost Regional team qualifier.
keyFacts:
  - label: Format
    value: Two-day net stroke-play ringer (best net per hole)
  - label: When
    value: A Friday–Saturday in January 2027 (exact dates TBD)
  - label: Where
    value: Landa Park Golf Course
  - label: The prize
    value: Winner's Belt + NIT spot + Roost Regional team seat
social:
  scoring:
    - "Two-day net ringer — same course Friday & Saturday"
    - "Each hole counts your best net score of the two days"
    - "Lowest 18-hole composite ringer total wins"
    - "Day 2: pick up once a hole can't beat your Day 1 score"
    - "Winner takes the NIT spot & a Roost Regional team seat"
...
Over two days you play the same 18 holes twice. Instead of adding up two full rounds, you build a single **ringer card**: for each hole, you take your **best net score of the two days**.
...
Refuges from **other Roosts** are welcome to enter — this isn't a STROH-only field. A couple of eligibility notes on what's at stake:

- **Any Refuge member** in the field can claim the **NIT spot**.
- **Only STROH members** can qualify for the **Roost Regional team**.
