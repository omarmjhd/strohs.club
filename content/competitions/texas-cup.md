...
keyFacts:
  - label: Format
    value: 3-round Ryder Cup — Best Ball, Scotch Foursomes & Singles
  - label: When
    value: Late March 2027 (dates TBD)
  - label: Where
...
Three days, Ryder Cup style — every match is worth points, and the team with the most points lifts the Cup. Across the weekend we play all three classic team formats:

- **Best Ball** — two-player teams, each plays their own ball, and the better score counts.
- **Scotch Foursomes** — alternate shot, with a twist: partners must each hit **a minimum of 3 drives per nine**.
- **Singles** — head-to-head match play.
...
- **Dates:** Late March 2027 — a Friday-through-Sunday weekend (exact dates TBD).
- **Venue:** [The Hideout](https://www.thehideouttexas.com/), Brownwood, TX.

## Cost

**TBD.** Cabin-style pricing (lodging plus green fees with carts and unlimited golf) will be announced as the event approaches — along with food and side games.

## Who Can Play & Sign-Ups
