...
Standings are kept in Google Sheets and read straight onto the site, so what you see here is
whatever the sheet said the moment you loaded the page. No waiting on anyone to publish an
update.

## Muni Tour

The full picture — playoff qualifiers, the three city standings, and a leaderboard for each of
